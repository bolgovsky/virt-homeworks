...
Оговорка:
Пытаюсь сделать красиво - скопировать красивую структуры из github и править уже её. 
Если подскажете как это делать ПРАВИЛЬНО - буду благодарен ))
...
2. При паравиртуализации 
    4. Гипервизор является как бы приложением в операционной системе хоста 
    5. операционная система управляют уже аппаратными ресурсами 
    6. Драйвера соответственно из операционной системы хоста
3. При виртуализации на основе операционной системы
    7. гипервизор- приложение 
    8. Используется функция ядра ОС хоста
    9. Гостевая система - изолированная экземпляр ОС хоста с уникальным набором настроек 
